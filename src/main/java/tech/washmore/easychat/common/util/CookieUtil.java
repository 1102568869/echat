package tech.washmore.easychat.common.util;
...
public class CookieUtil {
    ...
    public static void removeCookie(String name) {
        addCookie(SpringContextUtil.getHttpResponse(), name, StringUtils.EMPTY, 0);
    }
    ...
    public static Cookie getCurrentCookieByName(String name) {
        return getCookieByName(SpringContextUtil.getHttpRequest(), name);
    }
